Pod::Spec.new do |s|
  ...
  s.homepage              = 'https://github.com/ahmadvicky/SellonIosPicker'
  s.license               = { :type => "MIT", :file => "LICENSE" }

  s.author                = {'ahmadVicky' => 'vicky20and13@gmail.com'}
  s.social_media_url      = "https://github.com/ahmadvicky"

  s.source                = {:git => 'https://github.com/ahmadvicky/SellonIosPicker.git', :tag => s.version}
